                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="tempat_lahir" class="form-control" placeholder="masukan tempat lahirl">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="tgl_lahir" class="form-control" placeholder="tambah tanggal lahir">
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" name="telepon" class="form-control" placeholder="masukan no telpon">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
